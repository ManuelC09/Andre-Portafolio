      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full max-w-7xl">
        ...
        >
          ...
          <p className="text-base text-gray-300 max-w-lg leading-relaxed">
            Me especializo en hacer crecer comunidades online y gestionar
            estrategias digitales, impulsado por la organización, el liderazgo y
            los resultados. Ahora, mi objetivo es llevar estas habilidades al
            project management y liderar equipos exitosos.
          </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 pt-4 w-full">
            ...
            <div className="flex items-center gap-4 justify-center sm:justify-start">
              {[
                ...
                {
                  icon: Mail,
                  href: "mailto:alexandrerb2002@gmail.com?subject=Contacto%20desde%20portafolio&body=Hola%20Andr%C3%A9,%20quiero%20hablar%20contigo%20sobre...",
                },
              ].map((social, index) => (
                <a
                  key={index}
