...
export default function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      className="relative py-24 md:py-32 bg-[#020610] overflow-hidden border-t border-gray-800/50 w-full"
    >
      ...
      <div className="w-full px-6 md:px-10 mb-20 relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        >
          Explora los casos de éxito, estrategias de contenido y campañas
          virales que he liderado para estas marcas reconocidas de Nicaragua.
        </motion.p>
      </div>
